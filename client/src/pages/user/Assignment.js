...
const Assignment = () => {
  ...
  return (
      ...
      <p className = 'assignment-title'>Total Assigned<
          /p>
      ...
      <div className = 'assign-dashboard'>
      <p className = 'assignment-title'>Total Pending<
          /p>
      ...
      <p className = 'assignment-title'>Total Submitted<
          /p>
      ...
      (assignmentData?.result?.map(
          (assignment, index) => (
              ...
              <NavLink className = "" activeClassName = "is-active" to =
                   "/Workspace"><p className = 'assignment-name'>{
                  assignment['filename']}</p>
                    </NavLink>{
                  /* Display formatted date here */}<
                  p className = 'assignment-date'>uploaded on{
                  formatDate(
                      assignment['updatedAt'])}</p>
                  </div>
              <div className = 'assignment-small-container-2'>
              <button className = 'assignment-status' id =
                   'status' onClick = {null}>{assignment['status']}<
                  /button>
